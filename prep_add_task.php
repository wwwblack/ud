	...
	<div id="wrapper">
		<div id="header">
			...
			<nav role="navigation">
		     ...
		     <div id="content">
			  <h1>Занятия ВС 2016</h1>
			 <!-- Форма группы-->
				<div id="view_task">
		
					<a onclick="$('#name').slideToggle('slow');" href="javascript://">Свернуть/Развернуть занятие</a>				
				<form class="form-horizontal" method="post" action="save_edit.php">
					...
					<div  id="name" class="NavFrame">
						...
						<textarea class="textarea_add_task" rows="5"  style="resize:none" placeholder="Здесь записывается и редактируется сам текст занятия"></textarea><br>
					...
					<input class="button_green" type="submit" style="width:150px" value="Сохранить"/>
